...
contract fKNCpool is ERC20, ReentrancyGuard, Ownable {
  ...
  address poolTokenAddress = address(0xdd974D5C2e2928deA5F71b9825b8b646686BD200); //KNC
  IERC20 public poolToken  = IERC20(poolTokenAddress); //KNC

  address aaveTokenAddress = address(0x9D91BE44C06d373a8a226E1f3b146956083803eB);
